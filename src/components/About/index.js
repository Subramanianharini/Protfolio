      ...
      <div className="flex flex-row  gap-6 ml-8">
        <div className="flex-col mt-14 flex flex-auto w-64 gap-6">
          ...
          <p
            ...
            data-aos={"fade-left"}
          >
            I love Listening to music, reading comics and Watching Movies. I am
            currently pursuing BTech degree in Information Technology in Prathyusha Engineering College. I am {getDate()}{" "}
          ...
          >
            ...
            I worked on reactJs, Python, JavaScript, Java and many more. I am
        ...
        >
          ...
          <button className="py-3 mt-5 text-white mx-auto px-9 bg-blue-600 border-2 w-fit border-blue-500 rounded-3xl  hover:-translate-y-1.5 duration-[350ms] hover:duration-[350ms] hover:bg-blue-800 hover:scale-[1.023] focus:bg-blue-800 animate-zoomy">
            <a
              href={require("../../assets/files/HariniSK.pdf")}
              download={"Harini SK.pdf"}
            >
              Download CV
              <DownloadIcon />
            </a>
